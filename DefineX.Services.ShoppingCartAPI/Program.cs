using AutoMapper;
using DefineX.Services.ShoppingCartAPI;
using DefineX.Services.ShoppingCartAPI.DbContexts;
using DefineX.Services.ShoppingCartAPI.RabbitMQSender;
using DefineX.Services.ShoppingCartAPI.Repository;
