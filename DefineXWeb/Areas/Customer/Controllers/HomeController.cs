...
namespace DefineXWeb.Areas.Customer.Controllers
{
    [Area("Customer")]
    public class HomeController : Controller
    {
        ...
        public async Task<IActionResult> Details(int productId)
        {
            ...
            if (response != null && response.IsSuccess)
            {
                model = JsonConvert.DeserializeObject<Product>(Convert.ToString(response.Result));
            }
            return View(model);
        }
        ...
        public async Task<IActionResult> DetailsPost(Product Product)
        {
            ...
            {
                cartDetails.Product = JsonConvert.DeserializeObject<Product>(Convert.ToString(resp.Result));
            }
